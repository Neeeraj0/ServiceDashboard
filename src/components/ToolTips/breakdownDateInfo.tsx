...
const DateInfoTooltip: React.FC<DateInfoTooltipProps> = ({ 
  ...
  return (
    <div className="relative inline-block group z-9999">
      <button
        className="p-2 rounded-full text-blue-600 hover:bg-blue-100 transition-colors text-center mt-20"
      ...
      {/* Tooltip */}
      <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 bottom-full right-0 mb-2 w-[20vw] transition-all duration-300 ease-out z-[9999vw]">
        ...
        {/* Tooltip arrow */}
        <div className="w-3 h-3 bg-white border-r border-b border-gray-200 transform rotate-45 absolute -bottom-1.5 right-3"></div>
      </div>
    </div>
  );
};
