...
import { LayoutDashboardIcon, LogOut, LogOutIcon, MapIcon, MapPinned, PhoneIcon, SquareActivityIcon, User2 } from "lucide-react"
    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          // >
          //   <path
          //     d="M.954 1.12h.805v.213h-.705v4.374h3.118v-.52c.062.054.13.1.201.137v.596H.853V1.12h.1zm3.218 2.529V1.333h-.704V1.12h.905V3.512c-.073.038-.14.084-.2.137z"
          //     style={{ fill: "#212121" }}
          //   />
          //   <path
          //     d="M1.947.907H3.28c.06 0 .115.018.156.048a.188.188 0 0 1 .085.154v.342a.188.188 0 0 1-.085.154.272.272 0 0 1-.156.048H1.947a.272.272 0 0 1-.156-.048.188.188 0 0 1-.084-.154V1.11c0-.063.032-.117.084-.154a.272.272 0 0 1 .156-.048zm1.332.213H1.947a.069.069 0 0 0-.027.005v.31a.069.069 0 0 0 .027.005H3.28c.011 0 .02-.002.027-.005v-.31a.069.069 0 0 0-.027-.005zM4.954 4.253l.685-.303.092-.04.046.09.002.005a1.018 1.018 0 0 1-.521 1.347 1.018 1.018 0 0 1-1.348-.52 1.018 1.018 0 0 1 .522-1.348 1.02 1.02 0 0 1 .433-.087l.107.002-.003.106-.015.748zm.667-.062-.733.325-.153.067.004-.167.016-.802a.808.808 0 1 0 .417 1.543.806.806 0 0 0 .449-.966zM1.722 2.253H2.1v.431H1.67v-.431h.053zm.272.106h-.219v.219h.219v-.219zM2.902 2.355l.207.206.571-.572.076.075-.61.61-.037.038-.038-.038-.244-.244zM1.722 3.136H2.1v.432H1.67v-.432h.053zm.272.107h-.219v.219h.219v-.219zM2.902 3.238l.207.207.571-.572.076.075-.61.61-.037.037-.038-.037-.244-.244zM1.722 4.02H2.1v.432H1.67V4.02h.053zm.272.107h-.219v.218h.219v-.218zM2.902 4.122l.207.206.571-.571.076.075-.61.61-.037.037-.038-.037-.244-.244zM1.722 4.904H2.1v.432H1.67v-.432h.053zm.272.107h-.219v.218h.219v-.218zM2.902 5.006l.207.206.571-.572.076.076-.61.61-.037.037-.038-.038-.244-.243z"
          //     style={{ fill: "#212121" }}
          //   />
      ...
      },
      {
        ...
        <g fill="none" stroke="currentColor" stroke-width="62.717" transform="translate(91.594 974.827) scale(1.11612)">
      ...
      //   route: "#",
      //   children: [
      //     { label: "Open", route: "/piping/open"},
      //     { label: "Assigned", route: "/piping/assigned"},
      //     { label: "Completed", route: "/piping/completed"},
      //     { label: "Approval Pending", route: "/piping/approvalPending"}
      //   ],
      // },
      {
        icon: (
          <svg
            ...
            className="my-custom-icon" // Add a class for styling if needed
          >
            <path
